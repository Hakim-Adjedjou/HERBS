...
try:
    ...
    file = open("/mnt/nvme/measurements.txt", "a")
    ...
    while running:
        if measure_execute:
            ...
            save_measurement(current_position, cpt)  # ? Save to file
